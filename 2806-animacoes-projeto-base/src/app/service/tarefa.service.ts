...
export class TarefaService {
  ...
  //Variante subject -> é tipo especial no rxjs pode atuar como observer e observable
  private tarefasSubject = new BehaviorSubject<Tarefa[]>([]);

  //Cria observable que a fonte de dados é o subject
  ...
  criar(tarefa: Tarefa): void {
    this.http.post<Tarefa>(this.API, tarefa).subscribe((novaTarefa) => {
      ...
      //Adicionar tarefa no inicio do array
